...
dotnet publish -o .\aws\temp\publish --no-build -v n
...
Compress-Archive -Path .\aws\temp\publish\* -DestinationPath .\aws\temp\site.zip -Verbose -Force
...
Copy-Item .\aws\temp\site.zip .\aws\temp\visma-demo-app -Verbose
